...
public class LightsTests {
    ...
    @Test
    public void sphereDirectional1() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
        scene.setDistance(1000);
        scene.setBackground(Color.BLACK);
        ...
        scene.addGeometries(
                new Sphere(new Color(java.awt.Color.gray), new Material(0.5, 0.5, 100), 50, new Point3D(0, 0, 50)));
        scene.addLights(new SpotLight(new Color(600, 800, 0), new Point3D(-30, 20, -40),
                new Vector(4, -4, 4), 1, 0.0001, 0.00001));
        scene.addLights(new DirectionalLight(new Color(500, 20, 44), new Vector(1, -1, 1)));
        ImageWriter imageWriter = new ImageWriter("sphereDirectional1", 150, 150, 500, 500);
        Render render = new Render(imageWriter, scene);
